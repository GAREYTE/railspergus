			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="client.adresse.label" default="Adresse" /></th>
						...
						<g:sortableColumn property="telephone" title="${message(code: 'client.telephone.label', default: 'Telephone')}" />
				...
				<g:each in="${clientInstanceList}" status="i" var="clientInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${clientInstance.id}">${fieldValue(bean: clientInstance, field: "numero")}</g:link></td>
					
						<td>${fieldValue(bean: clientInstance, field: "adresse")}</td>
						...
						<td>${fieldValue(bean: clientInstance, field: "telephone")}</td>
