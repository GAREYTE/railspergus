			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'categorie.name.label', default: 'Name')}" />
				...
				<g:each in="${categorieInstanceList}" status="i" var="categorieInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${categorieInstance.id}">${fieldValue(bean: categorieInstance, field: "name")}</g:link></td>
