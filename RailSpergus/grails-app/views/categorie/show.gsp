	...
	<body>
		...
		<div id="show-categorie" class="content scaffold-show" role="main">
			...
			<ol class="property-list categorie">
				...
				<g:if test="${categorieInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="categorie.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${categorieInstance}" field="name"/></span>
